...
class RepresentationValid extends Mailable
{
    ...
    {
        $this->subject(config('app.name').' - '.__('emails.representation.valid.subject'));
    ...
    {
        return $this->markdown('emails.representation.valid', [
