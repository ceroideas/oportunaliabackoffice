...
class DirectSaleOfferExport implements FromCollection, WithColumnFormatting, WithColumnWidths, WithHeadings, WithMapping, WithStyles
{
	...
	public function collection()
	{
        ...
        $directSalesQuery = DirectSaleOffer::with([
         ...
         ->where("auctions.auction_type_id", 2)
