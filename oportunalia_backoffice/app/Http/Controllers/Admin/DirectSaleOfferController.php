...
class DirectSaleOfferController extends ApiController
{
    ...
    {
        $this->description = nl2br("Venta directa de la propiedad y no dejes pasar esta oportunidad.
            Situado en la prestigiosa Urbanización Sometimes, en la zona de Can Pastilla, este terreno se encuentra a escasos pasos del mar, ofreciendo un entorno privilegiado para la construcción de una vivienda unifamiliar o un proyecto residencial exclusivo. 
            La zona es conocida por su tranquilidad, proximidad a playas de arena blanca y excelente conexión con el centro de Palma y el aeropuerto. Además, cuenta con una amplia oferta de servicios, incluyendo restaurantes, tiendas y centros educativos, lo que la convierte en una ubicación ideal tanto para residencia habitual como para inversión
            La parcela dispone de una superficie de 600 m² y permite la edificación de una vivienda unifamiliar.
            Para más información, te invitamos a visitar www.oportunalia.com");
    }
    /**
    ...
    public function create(Request $request)
    {
        ...
        /*$validator2 = Validator::make($request->all(), [
            ...
            'conditions_document' => 'required|mimes:pdf',
        ...
        else
        {
            ...
            // return response()->json($values['auction_status_id'],422);
            ...
            $auction = Auction::create(array_merge($validator->validated(),
                [
                    ...
                    'auction_type_id' => AuctionType::DIRECT_SALE,
    ...
    public function duplicate(Request $request, $id)
    {
        ...
        if($auction->auction_status_id == 1 ||$auction->auction_status_id == 5 ||$auction->auction_status_id == 7){
            ...
            $new_active_name = $new_active->name . " - copia Venta Directa";
        ...
        $new_auction->title = $new_auction->title . " - copia Venta Directa";
    ...
    public function export($type)
    {
        $filename = [
            config('app.name'),
            __('fields.backoffice.direct_sales'),
        ];
        ...
        switch ($type)
        {
            ...
            case 'offersdirect':
                ...
                return \Maatwebsite\Excel\Facades\Excel::download(
                    new \App\Exports\Admin\DirectSaleOfferExport, $filename
                );
        ...
        try {
            ...
            $fotocasaData = [
                ...
                "PropertyFeature" => [
                    [
                        "FeatureId" => 3,
                        "TextValue" => $auctionData['description'] ?? 'Sin descripcion'
                    ],[
                        "FeatureId" => 2,
