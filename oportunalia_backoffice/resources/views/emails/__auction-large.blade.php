	...
	<div class="info">
		...
		<div class="email-clearfix" style="margin-bottom:16px">
			<div style="float:left">
				<div class="email-small" style="margin-bottom:10px">{{ __('emails.__product.lastBid') }}</div>
				<div class="email-black-big">{{ $product['lastBid'] }}€</div>
			</div>
			<div style="float:right">
				<div class="email-small" style="margin-bottom:10px;text-align:right">{{ __('emails.__product.startPrice') }}</div>
				<div class="email-black-big" style="text-align:right">{{ $product['startPrice'] }}€</div>
			</div>
			<div style="text-align:center">
				<div class="email-small" style="margin-bottom:10px">{{ __('emails.__product.bids') }}</div>
				<div class="email-black-big">{{ $product['total_bids'] }}</div>
			</div>
		</div>
