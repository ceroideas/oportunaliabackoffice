...
<html>
    ...
    <body>
        ...
        <div class="section-title uppercase text-navy">
            {{ __('pdf.cesion_final_report.description') }}
        </div>
        ...
        @if ($product->bids->count())
            ...
            <div class="section-title uppercase text-navy">
                {{ __('pdf.cesion_final_report.bid_history') }}
            </div>

            <table style="width:100%">
                <thead>
                    <tr class="bg-navy uppercase">
                        <th>{{ __('pdf.cesion_final_report.bid') }}</th>
                        <th>{{ __('pdf.cesion_final_report.user') }}</th>
                        <th>{{ __('pdf.cesion_final_report.date') }}</th>
                        <th>{{ __('pdf.cesion_final_report.time') }}</th>
                    </tr>
                </thead>
                <tbody>
            ...
            <div class="section-title uppercase text-navy">
                {{ __('pdf.cesion_final_report.auctionSummary') }}
            </div>
                ...
                <tbody>
                    <tr>
                        <td style="width:50%">
                            ...
                            <div class="table-label text-navy">{{ __('pdf.cesion_final_report.start_date') }}:
                        ...
                        <td>
                            <img class="table-image" src="{{ public_path('pdf-assets/calendario.jpg') }}">
                            <div class="table-label text-navy">{{ __('pdf.cesion_final_report.end_date') }}:
                    ...
                    <tr>
                        <td style="width:50%">
                            ...
                            <div class="table-label text-navy">{{ __('pdf.cesion_final_report.visits') }}:
                                {{ $product->views }}
                            </div>
                            <div class="clearfix"></div>
                        </td>
                        <td>
                            ...
                            <div class="table-label text-navy">{{ __('pdf.cesion_final_report.bids') }}:
                                {{ $product->bids->count() }}
                            </div>
                            <div class="clearfix"></div>
                        </td>
                    ...
                    <tr>
                        <td style="width:50%">
                            ...
                            <div class="table-label text-navy">{{ __('pdf.cesion_final_report.deposit') }}:
                        ...
                        <td>
                            <img class="table-image" src="{{ public_path('pdf-assets/dinero.jpg') }}">
                            <div class="table-label text-navy">{{ __('pdf.cesion_final_report.start_price') }}:
                    ...
                    <tr >
                        <td style="width:50%">
                            ...
                            <div class="table-label text-navy">{{ __('pdf.cesion_final_report.winner_bid') }}:
                    ...
                    <tr >
                        <td>
                            ...
                            <div>
                                <div class="table-label text-navy">{{ __('pdf.cesion_final_report.adjudicated') }}:
            ...
            {{--
            <div class="section-title uppercase text-navy">
                {{ __('pdf.cesion_final_report.adjudicated') }}
            </div>

            <p>
                {{ __('pdf.cesion_final_report.declaration') }}:
            </p>
            ...
            <table class="bg-formgray" style="width:100%">
                <tbody>
                    <tr>
                        <td class="border-right-navy" style="width:35%">
                            <div class="clearfix"></div>
                            <img class="table-image" src="{{ public_path('pdf-assets/icon-speaker.png') }}">
                            <div class="table-label text-navy">{{ __('pdf.cesion_final_report.announcement') }}</div>
                            <div class="clearfix"></div>
                        </td>
                        <td>
                            <p>{{ $product->title }}</p>
                    ...
                    <tr>
                        <td class="border-right-navy" style="width:35%">
                            ...
                            <div class="table-label text-navy">{{ __('pdf.cesion_final_report.adjudicated') }}</div>
                            <div class="clearfix"></div>
                        </td>
                        <td>
                            @if ($product->last_bid && $product->last_bid->user)
                                <div>{{ $product->last_bid->user->firstname }} {{ $product->last_bid->user->lastname }}</div>
                                <div>{{ __('pdf.cesion_final_report.email') }}: {{ $product->last_bid->user->email }}</div>
                                <div>{{ __('pdf.cesion_final_report.phone') }}: {{ $product->last_bid->user->phone }}</div>
                                <div>{{ __('pdf.cesion_final_report.address') }}: {{ $product->last_bid->user->address }}</div>
                                <div>{{ __('pdf.cesion_final_report.cp') }}: {{ $product->last_bid->user->cp }}</div>
                                <div>{{ __('pdf.cesion_final_report.document_number') }}: {{ $product->last_bid->user->document_number }}</div>
                            @endif
                        </td>
                    </tr>
                    <tr class="bg-formgray">
                        <td class="border-right-navy" style="width:35%">
                            ...
                            <div class="table-label text-navy">{{ __('pdf.cesion_final_report.amount') }}</div>
                            <div class="clearfix"></div>
                        </td>
                        <td>
                            @if ($product->last_bid)
                                <p>{{ number_format($product->last_bid->import, 2, ',', '.') }} &euro;</p>
                            @endif
                        </td>
                    </tr>
                    <tr class="bg-formgray">
                        <td class="border-right-navy" style="width:35%">
                            ...
                            <div class="table-label text-navy">{{ __('pdf.cesion_final_report.commission') }}</div>
                            <div class="clearfix"></div>
                        </td>
                        <td>
                            <p>{{ number_format($product->commission_import, 2, ',', '.') }} &euro;</p>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        @else
            {{-- inicio de cesion de remate desierta --}}
            <div class="section-title uppercase text-navy">
                {{ __('pdf.cesion_final_report.bid_history') }}
            </div>
            <h1 class="title text-navy">La cesi&oacute;n de remate no tuvo ofertas</h1>
