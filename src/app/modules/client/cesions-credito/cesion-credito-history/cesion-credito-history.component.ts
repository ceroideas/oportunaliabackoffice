...
@Component({
  selector: 'app-cesion-credito-history',
  templateUrl: './cesion-credito-history.component.html',
  styleUrls: ['./cesion-credito-history.component.scss']
})
export class CesionCreditoHistoryComponent implements OnInit {
  ...
  initTable(): void {
		...
		this.dtOptions = {
			...
			dom: `tip`,
			ajax: {
				url: endpoint('cesion_credito_history_dt', { id: this.cesionId }),
				type: 'get',
				headers: {
			...
			initComplete: function(settings, json) {
				...
				let table_id = '#cesion-credito-ofertas';
	...
	reloadTable() {
		...
		let newUrl = endpoint('cesion_credito_history_dt', { id: this.cesionId });
