...
@Component({
  ...
  templateUrl: './cesion-create.component.html',
  styleUrls: ['./cesion-create.component.scss']
})
export class CesionCreateComponent implements OnInit {
  ...
  setFormFields() {
	...
	saveCesion(draft = false) {
		...
		if (this.form.valid) {
			...
			this.auctionsService.saveCesion(data)
			.subscribe(data => {
