...
@Component({
	selector: 'app-user-direct-sellings',
	templateUrl: './user-direct-sellings.component.html',
	styleUrls: ['./user-direct-sellings.component.scss']
})
export class UserDirectSellingsComponent implements OnInit {
	...
	initTable(): void {
		...
		this.dtOptions = {
			...
			ajax: {
				url: endpoint('user_direct_sellings_dt', { id: this.userId }),
				type: 'get',
				headers: {
				...
				},
        {
			...
			initComplete: function(settings, json) {
				...
				let table_id = '#usuario-ventas-directas';
	...
	reloadTable() {
		...
		let newUrl = endpoint('user_direct_sellings_dt', params);
